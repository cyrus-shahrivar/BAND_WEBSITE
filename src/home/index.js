...
import showsTemplate from './templates/shows.html';
import subscribeTemplate from './templates/subscribe.html';
import videosTemplate from './templates/videos.html';
...
var sections = [
    {
        sectionName: 'shows',
        sectionTemplate: showsTemplate
    },
    {
        sectionName: 'videos',
        sectionTemplate: videosTemplate
    },
    {
        sectionName: 'about',
        sectionTemplate: aboutTemplate
    },
    {
        sectionName: 'contact',
        sectionTemplate: contactTemplate
    },
    {
        sectionName: 'subscribe',
        sectionTemplate: subscribeTemplate
    }
];
var sectionObjects = sections.map(function (section) {
    section.$sectionElement = $('.' + section.sectionName + '-section');
    return section;
});
